...
import medi from "../assets/meditation.png"
const Pages = () => {
    return (
        <div className="bg-white ">
            <section className="container items-center px-4 pb-12 mx-auto mt-20 lg:flex md:px-40" id='medi'>
                ...
                <div>
                    <img
                        src={medi}
                        className="w-64 mx-auto mt-6 sm:w-10/12 lg:w-64"
                    />
                </div>
