    ...
    <div>
       <div className="bg-white ">
            ...
            <div>
                    <img
                        src={sleep}
                        className="w-52 mx-auto mt-6 sm:w-10/12 lg:w-60"
                    />
                </div>

                <div className="flex-1 space-y-4 sm:text-center lg:text-left" id='sleep'>
                    ...
                    When we meditate, we inject far-reaching and long-lasting benefits into our lives: We lower our stress levels, we get to know our pain, we connect better, we improve our focus, and we're kinder to ourselves. Let us walk you through the basics in our new mindful guide on how to meditate Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione magnam aliquam impedit culpa quod veritatis repudiandae corporis quae consequuntur. Distinctio quibusdam, harum minus ducimus beatae ad est porro vero quae...
                    </p>
